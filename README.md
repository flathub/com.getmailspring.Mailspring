...
flatpak-node-generator npm --node-sdk-extension org.freedesktop.Sdk.Extension.node26//26.08 --electron-node-headers -r package-lock.json -o ../generated-sources.json
```
