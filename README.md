...
flatpak-node-generator npm --node-sdk-extension org.freedesktop.Sdk.Extension.node22//25.08 --electron-node-headers -r package-lock.json -o ../generated-sources.json
```
